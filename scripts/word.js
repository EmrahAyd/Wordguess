  ...
  if (sonuc >= 0) {
    ...
    function controler(harfi) {
      if (harfi.value == kelime[i]) {
        ...
        harfi.value == kelime[(i + 1) % 7] ||
        harfi.value == kelime[(i + 2) % 7] ||
        harfi.value == kelime[(i + 3) % 7] ||
        harfi.value == kelime[(i + 4) % 7]
      ) {
    ...
    document.getElementById("birinci").classList.add("bounceIn");
    function regeri() {
...
function keyup2() {
  ...
  if (sonuc >= 0) {
    ...
    document.getElementById("ikinci").classList.add("bounceIn");
    function regeri() {
...
function keyup3() {
  ...
  if (sonuc >= 0) {
    ...
    document.getElementById("ucuncu").classList.add("bounceIn");
    function regeri() {
...
function keyup4() {
  ...
  if (sonuc >= 0) {
    ...
    document.getElementById("dorduncu").classList.add("bounceIn");
    function regeri() {
...
function keyup5() {
  ...
  if (sonuc >= 0) {
    ...
    document.getElementById("besinci").classList.add("bounceIn");
    function regeri() {
      document.getElementById("ikinci").classList.remove("bounceIn");
    }
    setInterval(regeri, 3000);
